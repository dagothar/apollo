...
#define autopilot_rtModel              RT_MODEL_autopilot

/* Block signals (auto storage) */
typedef struct {
  real_T PacketInput_o3[2];            /* '<S1>/Packet Input' */
  real_T PacketInput_o4[7];            /* '<S1>/Packet Input' */
  real_T PacketInput_o5[6];            /* '<S1>/Packet Input' */
  real_T PacketInput_o6[8];            /* '<S1>/Packet Input' */
  real_T RateTransition3[2];           /* '<S1>/Rate Transition3' */
  real_T RateTransition4[7];           /* '<S1>/Rate Transition4' */
  real_T RateTransition5[6];           /* '<S1>/Rate Transition5' */
  real_T RateTransition6[8];           /* '<S1>/Rate Transition6' */
  ...
  real_T DataTypeConversion_o;         /* '<S4>/Data Type Conversion' */
  real_T DerivativeGain_e;             /* '<S8>/Derivative Gain' */
  real_T FilterCoefficient_f;          /* '<S8>/Filter Coefficient' */
  real_T IntegralGain_k;               /* '<S8>/Integral Gain' */
  real_T ProportionalGain_i;           /* '<S8>/Proportional Gain' */
  real_T Switch_l;                     /* '<S4>/Switch' */
  real_T Sum;                          /* '<S5>/Sum' */
  real_T DataTypeConversion_c;         /* '<S5>/Data Type Conversion' */
  real_T DerivativeGain_i;             /* '<S9>/Derivative Gain' */
  real_T FilterCoefficient_c;          /* '<S9>/Filter Coefficient' */
  real_T IntegralGain_a;               /* '<S9>/Integral Gain' */
  real_T ProportionalGain_o;           /* '<S9>/Proportional Gain' */
  real_T Switch_i;                     /* '<S5>/Switch' */
  real_T DataTypeConversion_l;         /* '<S6>/Data Type Conversion' */
  real_T DerivativeGain_ei;            /* '<S10>/Derivative Gain' */
  real_T FilterCoefficient_e;          /* '<S10>/Filter Coefficient' */
  real_T IntegralGain_m;               /* '<S10>/Integral Gain' */
  real_T ProportionalGain_l;           /* '<S10>/Proportional Gain' */
  real_T Switch_e;                     /* '<S6>/Switch' */
  int32_T PacketInput_o1;              /* '<S1>/Packet Input' */
  int32_T PacketInput_o2;              /* '<S1>/Packet Input' */
  ...
  boolean_T LogicalOperator_i;         /* '<S5>/Logical Operator' */
  boolean_T LogicalOperator_d;         /* '<S6>/Logical Operator' */
} BlockIO_autopilot;
...
typedef struct {
  ...
  real_T Filter_CSTATE_l;              /* '<S8>/Filter' */
  real_T Integrator_CSTATE_d;          /* '<S8>/Integrator' */
  real_T Filter_CSTATE_i;              /* '<S9>/Filter' */
  real_T Integrator_CSTATE_e;          /* '<S9>/Integrator' */
  real_T Filter_CSTATE_p;              /* '<S10>/Filter' */
  real_T Integrator_CSTATE_n;          /* '<S10>/Integrator' */
} ContinuousStates_autopilot;
...
typedef struct {
  ...
  real_T Filter_CSTATE_p;              /* '<S10>/Filter' */
  real_T Integrator_CSTATE_n;          /* '<S10>/Integrator' */
} StateDerivatives_autopilot;

/* State disabled  */
typedef struct {
  boolean_T Filter_CSTATE;             /* '<S7>/Filter' */
  boolean_T Integrator_CSTATE;         /* '<S7>/Integrator' */
  boolean_T Filter_CSTATE_l;           /* '<S8>/Filter' */
  boolean_T Integrator_CSTATE_d;       /* '<S8>/Integrator' */
  boolean_T Filter_CSTATE_i;           /* '<S9>/Filter' */
  boolean_T Integrator_CSTATE_e;       /* '<S9>/Integrator' */
  boolean_T Filter_CSTATE_p;           /* '<S10>/Filter' */
  boolean_T Integrator_CSTATE_n;       /* '<S10>/Integrator' */
} StateDisabled_autopilot;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Filter_Reset_ZCE;         /* '<S7>/Filter' */
  ZCSigState Integrator_Reset_ZCE;     /* '<S7>/Integrator' */
  ZCSigState Filter_Reset_ZCE_k;       /* '<S8>/Filter' */
  ZCSigState Integrator_Reset_ZCE_k;   /* '<S8>/Integrator' */
  ZCSigState Filter_Reset_ZCE_a;       /* '<S9>/Filter' */
  ZCSigState Integrator_Reset_ZCE_h;   /* '<S9>/Integrator' */
  ZCSigState Filter_Reset_ZCE_b;       /* '<S10>/Filter' */
  ZCSigState Integrator_Reset_ZCE_j;   /* '<S10>/Integrator' */
} PrevZCSigStates_autopilot;
...
#define rtB                            autopilot_B
#define BlockIO                        BlockIO_autopilot
#define rtX                            autopilot_X
#define ContinuousStates               ContinuousStates_autopilot
#define rtP                            autopilot_P
#define Parameters                     Parameters_autopilot
#define rtDWork                        autopilot_DWork
#define D_Work                         D_Work_autopilot
#define rtPrevZCSigState               autopilot_PrevZCSigState
#define PrevZCSigStates                PrevZCSigStates_autopilot

/* Parameters (auto storage) */
struct Parameters_autopilot_ {
  ...
  real_T Switch_Threshold_a;           /* Expression: 0
                                        ...
                                        */
  real_T DerivativeGain_Gain_j;        /* Expression: D
  ...
  real_T FilterCoefficient_Gain_b;     /* Expression: N
                                        ...
                                        */
  real_T IntegralGain_Gain_k;          /* Expression: I
  ...
  int32_T PacketOutput_PacketID;       /* Expression: PacketID
                                        ...
                                        */
  int32_T BitwiseOperator_BitMask;     /* Expression: BitMask
                                        * Referenced by: '<S3>/Bitwise Operator'
                                        */
  int32_T BitwiseOperator_BitMask_f;   /* Expression: BitMask
                                        * Referenced by: '<S4>/Bitwise Operator'
                                        */
  int32_T BitwiseOperator_BitMask_k;   /* Expression: BitMask
                                        * Referenced by: '<S5>/Bitwise Operator'
                                        */
  int32_T BitwiseOperator_BitMask_a;   /* Expression: BitMask
                                        * Referenced by: '<S6>/Bitwise Operator'
                                        */
};

/* Real-time Model Data Structure */
struct RT_MODEL_autopilot {
  const char_T *path;
...
extern Parameters_autopilot autopilot_P;

/* Block signals (auto storage) */
extern BlockIO_autopilot autopilot_B;

/* Continuous states (auto storage) */
extern ContinuousStates_autopilot autopilot_X;
...
/* Zero-crossing (trigger) state */
extern PrevZCSigStates_autopilot autopilot_PrevZCSigState;

/* Model entry point functions */
extern void autopilot_initialize(boolean_T firstTime);
extern void autopilot_output(int_T tid);
extern void autopilot_update(int_T tid);
extern void autopilot_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_autopilot *autopilot_M;
 ...
 * '<Root>' : autopilot
 * '<S1>'   : autopilot/APOLLO
 * '<S2>'   : autopilot/Subsystem
 * '<S3>'   : autopilot/reg pitch
 * '<S4>'   : autopilot/reg roll
 * '<S5>'   : autopilot/reg wys
 * '<S6>'   : autopilot/reg yaw
 * '<S7>'   : autopilot/reg pitch/PID Controller
 * '<S8>'   : autopilot/reg roll/PID Controller
 * '<S9>'   : autopilot/reg wys/PID Controller
 * '<S10>'  : autopilot/reg yaw/PID Controller
 */
