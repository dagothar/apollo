...
MODEL                := autopilot
MODULES              := autopilot_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
...
#
MODELLIB                  := autopilotlib_rtwin.lib
MODELREF_LINK_LIBS        := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);S:/praca/apollo/apollo/simulink/autopilot_rtwin;S:/praca/apollo/apollo/simulink
