...
MAKECMD         = "d:/PROGRA~1/MATLAB/R2010a/bin/win32/gmake"
HOST            = PC
BUILD           = yes
...
MODEL                := r
MODULES              := r_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := r.mk
MATLAB_ROOT          := d:/PROGRA~1/MATLAB/R2010a
MATLAB_BIN           := d:/PROGRA~1/MATLAB/R2010a/bin
S_FUNCTIONS          := 
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 2
...
#
MODELLIB                  := rlib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := r_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);S:/praca/apollo/apollo/simulink/r_rtwin;S:/praca/apollo/apollo/simulink
