...
typedef struct {
  ...
  real_T DataTypeConversion_f;         /* '<S4>/Data Type Conversion' */
  real_T DerivativeGain_f;             /* '<S8>/Derivative Gain' */
  real_T FilterCoefficient_k;          /* '<S8>/Filter Coefficient' */
  real_T IntegralGain_j;               /* '<S8>/Integral Gain' */
  real_T ProportionalGain_c;           /* '<S8>/Proportional Gain' */
  real_T Switch_f;                     /* '<S4>/Switch' */
  real_T Sum;                          /* '<S5>/Sum' */
  real_T DataTypeConversion_j;         /* '<S5>/Data Type Conversion' */
  real_T DerivativeGain_j;             /* '<S9>/Derivative Gain' */
  real_T FilterCoefficient_j;          /* '<S9>/Filter Coefficient' */
  real_T IntegralGain_d;               /* '<S9>/Integral Gain' */
  real_T ProportionalGain_l;           /* '<S9>/Proportional Gain' */
  real_T Switch_n;                     /* '<S5>/Switch' */
  real_T DataTypeConversion_c;         /* '<S6>/Data Type Conversion' */
  real_T DerivativeGain_ff;            /* '<S10>/Derivative Gain' */
  real_T FilterCoefficient_h;          /* '<S10>/Filter Coefficient' */
  real_T IntegralGain_o;               /* '<S10>/Integral Gain' */
  real_T ProportionalGain_g;           /* '<S10>/Proportional Gain' */
  ...
  boolean_T LogicalOperator_d;         /* '<S4>/Logical Operator' */
  boolean_T LogicalOperator_g;         /* '<S5>/Logical Operator' */
  boolean_T LogicalOperator_l;         /* '<S6>/Logical Operator' */
} BlockIO_r;
...
typedef struct {
  ...
  real_T Filter_CSTATE_k;              /* '<S8>/Filter' */
  real_T Integrator_CSTATE_p;          /* '<S8>/Integrator' */
  real_T Filter_CSTATE_e;              /* '<S9>/Filter' */
  real_T Integrator_CSTATE_l;          /* '<S9>/Integrator' */
  real_T Filter_CSTATE_g;              /* '<S10>/Filter' */
...
typedef struct {
  ...
  boolean_T Filter_CSTATE_k;           /* '<S8>/Filter' */
  boolean_T Integrator_CSTATE_p;       /* '<S8>/Integrator' */
  boolean_T Filter_CSTATE_e;           /* '<S9>/Filter' */
  boolean_T Integrator_CSTATE_l;       /* '<S9>/Integrator' */
  boolean_T Filter_CSTATE_g;           /* '<S10>/Filter' */
...
typedef struct {
  ...
  ZCSigState Filter_Reset_ZCE_d;       /* '<S8>/Filter' */
  ZCSigState Integrator_Reset_ZCE_d;   /* '<S8>/Integrator' */
  ZCSigState Filter_Reset_ZCE_b;       /* '<S9>/Filter' */
  ZCSigState Integrator_Reset_ZCE_b;   /* '<S9>/Integrator' */
  ZCSigState Filter_Reset_ZCE_j;       /* '<S10>/Filter' */
  ZCSigState Integrator_Reset_ZCE_h;   /* '<S10>/Integrator' */
} PrevZCSigStates_r;
...
#define rtB                            r_B
#define BlockIO                        BlockIO_r
#define rtX                            r_X
#define ContinuousStates               ContinuousStates_r
#define rtP                            r_P
#define Parameters                     Parameters_r
#define rtDWork                        r_DWork
#define D_Work                         D_Work_r
#define rtPrevZCSigState               r_PrevZCSigState
#define PrevZCSigStates                PrevZCSigStates_r

/* Parameters (auto storage) */
struct Parameters_r_ {
  ...
  real_T Switch_Threshold;             /* Expression: 0
                                        ...
                                        */
  real_T DerivativeGain_Gain_i;        /* Expression: D
  ...
  int32_T BitwiseOperator_BitMask;     /* Expression: BitMask
                                        ...
                                        */
  int32_T BitwiseOperator_BitMask_m;   /* Expression: BitMask
                                        * Referenced by: '<S4>/Bitwise Operator'
                                        */
  int32_T BitwiseOperator_BitMask_n;   /* Expression: BitMask
                                        * Referenced by: '<S5>/Bitwise Operator'
                                        */
  int32_T BitwiseOperator_BitMask_l;   /* Expression: BitMask
...
extern Parameters_r r_P;

/* Block signals (auto storage) */
extern BlockIO_r r_B;

/* Continuous states (auto storage) */
extern ContinuousStates_r r_X;

/* Block states (auto storage) */
extern D_Work_r r_DWork;

/* External data declarations for dependent source files */

/* Zero-crossing (trigger) state */
extern PrevZCSigStates_r r_PrevZCSigState;

/* Model entry point functions */
extern void r_initialize(boolean_T firstTime);
extern void r_output(int_T tid);
extern void r_update(int_T tid);
extern void r_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_r *r_M;
 ...
 * '<S5>'   : r/reg wys
 * '<S6>'   : r/reg yaw
 * '<S7>'   : r/reg pitch/PID Controller
 * '<S8>'   : r/reg roll/PID Controller
 * '<S9>'   : r/reg wys/PID Controller
 * '<S10>'  : r/reg yaw/PID Controller
 */
